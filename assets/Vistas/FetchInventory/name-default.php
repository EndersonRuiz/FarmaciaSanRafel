<?php
    ...
    $columnasParaRetorno = array(
     ...
     $columnasParaRetorno_1 = array(
        ...
        $tablasDeBBDD[1].'.PrecioVenta',
        $tablasDeBBDD[2].'.Nombre',
        $tablasDeBBDD[3].'.Nombre as Sucursal',
    );
    ...
    $reglasDeFiltradoDeRelaciones .= "AND ".$tablasDeBBDD[3].".Codigo = ".$tablasDeBBDD[0].".IdSucursal ";
    $reglasDeFiltradoDeRelaciones .= "AND ".$tablasDeBBDD[1].".IdCategoria = ".$tablasDeBBDD[2].".Codigo) ";
...
/////////////////////////////////////// FIN DE REGLAS DE ORDENACION ////////////////////
    ...
    foreach ($DataSet as $DL){
        ...
        $registro[] = "<td><center><a href='index.php?view=EditInventory&Codigo=".$ProductId."'><span class='glyphicon glyphicon-pencil'></span></a></center></td>";
