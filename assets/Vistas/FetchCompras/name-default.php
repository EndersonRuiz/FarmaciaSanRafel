<?php
    ...
    $columnasParaRetorno = array(
        ...
        $tablasDeBBDD[0].'.FechaFac1', 
        $tablasDeBBDD[0].'.Fecha', 
        $tablasDeBBDD[0].'.Hora',
        $tablasDeBBDD[0].'.NumeroFactura',
        $tablasDeBBDD[0].'.Laboratorio',
        $tablasDeBBDD[1].'.PrimerNombre',
    ...
    $reglasDeFiltradoDeRelaciones .= " (".$tablasDeBBDD[0].".IdUsuario = ".$tablasDeBBDD[1].".Codigo )";
...
/////////////////////////////////////// FIN DE REGLAS DE ORDENACION ////////////////////
    ...
    foreach ($DataSet as $DL){
        ...
        $registro[] = '<td><center><a href="#" data-toggle="modal" data-target="#modalContactForm" onclick="DataProduct_3('.$ProductId.')"><i class="fa fa-eye"></i></a></center></td>';

        $registro[] = '<td><center><a href="#" data-toggle="modal" data-target="#infoProduct12" onclick="DataProduct456('.$ProductId.')"><i class="fa fa-eye"></i></a></center></td>';
