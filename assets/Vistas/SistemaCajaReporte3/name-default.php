							...
							<div class="full-width panel-content">
								<div class="row">
									<?
								        ...
								        foreach($model->ReporteVentasSanRafa11($_REQUEST['Inicio'],$_REQUEST['Sucursal'],$_REQUEST['Turnos']) as $r): 
								    ?>
									<br></br>
                                    <div class="col-md-3">
                                    	Total Venta
							 ...
							 <div class="full-width divider-menu-h"></div>
								<div class="row table-responsive">
									<table class="table table-bordered table-hover" class="table table-striped" >
								        ...
								        $model = new Ventas ();
								        //CARGAR LOS CAMPOS A LA VARIABLE $r
								        foreach($model->ReporteVentasSanRafa111($_REQUEST['Inicio'],$_REQUEST['Sucursal'],$_REQUEST['Turnos']) as $r): 
								         ?>
											<tr>
												<td> 
							...
							<table class="table table-bordered table-hover display" class="table table-striped" id="TableUsers">
								...
								<tbody>
									<?
								        ...
								        $model = new Ventas ();
								        //CARGAR LOS CAMPOS A LA VARIABLE $r
								        foreach($model->ReporteVentasSanRafa1($_REQUEST['Inicio'],$_REQUEST['Sucursal'],$_REQUEST['Turnos']) as $r): 
								    ?>
						            <tr>
