...
Highcharts.chart('container', {
    ...
    series: [{
        ...
        data: [
            ...
            foreach ($model->ReportePastel123('1',$_REQUEST['Inicio'],$_REQUEST['InicioFin']) as $r) 
                {
                  echo " ['".$r->NombreCompleto."',".$r->Resultado1."],";
               }
            ?>
        ]
    }]
...
Highcharts.chart('container1', {
    ...
    series: [{
        ...
        data: [
            <? $model = new  Existencias();
            foreach ($model->ReportePastel('1',$_REQUEST['Inicio'],$_REQUEST['InicioFin']) as $r) 
                {
                  echo " ['".$r->NombreCompleto."',".$r->Resultado1."],";
               }
            ?>
...
Highcharts.chart('container2', {
    ...
    series: [{
        ...
        data: [
            <? $model = new  Existencias();
            foreach ($model->ReportePastel1234('1',$_REQUEST['Inicio'],$_REQUEST['InicioFin']) as $r) 
                {
                  echo " ['".$r->NombreCompleto."',".$r->Resultado1."],";
               }
            ?>
