<?php
    ...
    $reglasDeFiltradoDeRelaciones .= "AND ".$tablasDeBBDD[1].".IdCategoria = ".$tablasDeBBDD[2].".Codigo AND inventario.IdSucursal = '1' ) ";
   ...
   // echo $consulta."<br></br>";
    ...
    foreach ($DataSet as $DL){
        ...
        $registro[] = '<td><center><a href="#" data-toggle="modal" data-target="#infoProduct" onclick="DataProduct('.$ProductId.')"><i class="fa fa-eye"></i></a></center></td>';
         ...
         $registro[] = '<td><center><a class="btn btn-primary" href="#" data-toggle="modal" data-target="#ingresos" onclick="IngresarProducto('.$ProductId.')">Entrada</a></center></form></td>';
