...
<body onload="Repetir()">
						...
						<div class="full-width panel mdl-shadow--2dp">
							...
							<div class="full-width panel-content">
								<div class="row">
                                   ...
                                   <button  class="btn btn-primary" style="background-color: #080F83 " onclick="insertarDatos2()" data-target="#modalContactForm1" data-toggle="modal">
                                        <i class="glyphicon glyphicon-shopping-cart" ></i> ++++
                                   </button>

                                   <button  class="btn btn-primary" style="background-color: #080F83 " onclick="insertarDatos1()" data-target="#modalContactForm2" data-toggle="modal">
                                        <i class="glyphicon glyphicon-shopping-cart" ></i> - - - -
                                   </button>
                                   <br></br>
                                </div>
								...
								<div class="row table-responsive">
									<table class="table table-bordered table-hover" class="table table-striped" >
										<thead class="bg-primary">
											<tr style="background-color: #7B0D1A;">
												<th width="50px">
													<center>
														Cantidad
													</center>
										...
										<tbody>
											<tr>
												...
												<td> 
													<button type="submit" class="btn btn-primary" id="AgregarAFactura" style="background-color: #080F83 ">
							...
							<div class="container">
						 		<div class="row">
									...
									<div class="panel panel-info">
										...
										<div class="panel-body detalle-producto">
											<?php
											session_start();
											 if(count($_SESSION['DetalleRafael'])>0){?>
												<table class="table">
												    <thead>
												        <tr>
												        	<th>Id</th>
												    ...
												    <tbody>
												    	<?php
												    	foreach($_SESSION['DetalleRafael'] as $k => $detalle){
												    	?>
												        <tr>
												            ...
												            <td><button type="button" class="btn btn-sm eliminar-producto" style="background-color: #080F83 " id="<?php echo $detalle['id'];?>">Eliminar</button></td>
												        </tr>
												        <?php }?>
												    </tbody>
												</table>
								...
								<div class="row">
									<div class="col-md-2 text-right">
										<button  class="btn btn-primary" style="background-color: #080F83 " onclick="DatosVacios()" data-target="#modalContactForm3" data-toggle="modal">
	...
	<script>
        ...
        chosen_ajaxify('cbo_producto', 'index.php?view=AutoCompleteSales&keyword=');
       ...
       function DataProduct456(ProductoVenta) 
        {   
		    if (ProductoVenta) 
		    {
		        ...
		        $.ajax({
		            url: 'index.php?view=DetalleFacturaSanRafael',
		            type: 'post',
        ...
        $('#AgregarAFactura').unbind('click').bind('click', function(){
	        ...
	        {
	        	$.ajax({
					url: 'index.php?view=VerificaExistenciaRafael',
					type: 'post',
					data: {
					...
					success: function(data) 
					{
						if(data.success==true)
						{
							...
							$(".detalle-producto").load('index.php?view=DetalleVentaSanRafael');
						}
						else
						{
		...
		$(".eliminar-producto").on("click", function(e) 
		{
			var id = $(this).attr("id");
			$.ajax({
				url: 'index.php?view=DetalleVentaSanRafael',
				type: 'post',
				data: {'id':id},
				dataType: 'json'
			}).done(function(data)
		...
		$(".guardar-carrito").on("click", function(e) 
		{
			...
			{  
				 ...
				 $.ajax({
					url: 'index.php?view=AddDetalleVentaSanRafael',
					type: 'post',
