<?php
    ...
    if($_REQUEST['Sucursal'] == '4'){
	foreach ($model->ReportedeCorteCaja($_REQUEST['Sucursal'],$_REQUEST['Inicio'],$_REQUEST['Turnos']) as $r) 
	{
	...
	}else if($_REQUEST['Sucursal'] == '5'){
	foreach ($model->ReportedeCorteCajas($_REQUEST['Sucursal'],$_REQUEST['Inicio'],$_REQUEST['Turnos']) as $r) 
	{
	...
	}else if($_REQUEST['Sucursal'] == '1'){
	foreach ($model->ReportedeCorteCajass($_REQUEST['Sucursal'],$_REQUEST['Inicio'],$_REQUEST['Turnos']) as $r) 
	{
