...
<body>
     <!-- pageContent -->
	<section class="full-width pageContent" style="background-color: #E9FBFB">
			...
			<div class="mdl-tabs__panel is-active" id="tabNewAdmin">
				<div class="mdl-grid">
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
						<div class="full-width panel mdl-shadow--2dp" style="background-color: #CEF7F6">
  ...
  function EnviarCodigo(ProductoVenta) {
   ...
   function onClickBotonCobrar(){
    ...
    if (CodigoVenta1 == '' || CodigoSleiter == '')
      ...
      else if(CodigoSleiter == '123Contraseña/')
      {
