...
<body>
     <!-- pageContent -->
	<section class="full-width pageContent" style="background-color: #D7EDD6">
			...
			<div class="mdl-tabs__panel is-active" id="tabNewAdmin">
				<div class="mdl-grid">
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
						<div class="full-width panel mdl-shadow--2dp" style="background-color: #A7CDA5">
							<div class="full-width panel-tittle text-center tittles" style="background-color: #FFA500;">
								Sistema de Caja Farmacia San Juan
							</div>
							<div class="full-width panel-tittle text-center tittles" style="background-color: #FFA500;">
						             <button id="send" class="btn btn-info">
            	             <a href="#" data-toggle="modal" data-target="#modalContactForm3" class="btn btn-primary" ><i class="fa fa-folder-open">Abrir Caja FSJ</i></a> 
            	           </button>

            	           <button id="send" class="btn btn-info">
            	             <a href="#" data-toggle="modal" data-target="#modalContactForm4" class="btn btn-primary" ><i class="fa fa-folder-open">Salidas Efectivo FSJ</i></a> 
            	           </button>

            	           <button id="send" class="btn btn-info">
            	             <a href="index.php?view=SistemaCajaSJ" data-toggle="modal" class="btn btn-primary" ><i class="fa fa-folder-open">Ventas FSJ</i></a> 
            	           </button>

            	           <button id="send" class="btn btn-info">
            	             <a href="#" data-toggle="modal" data-target="#modalContactForm6" class="btn btn-primary" ><i class="fa fa-folder-open">Cerrar Caja FSJ</i></a> 
            	           </button>
          ...
          <h4 class="alert-heading">Venta <?echo $cont;?></h4>
             <p>
                  <table class="table" >
                    ...
                    <tbody>
                        <?php
                          foreach($model->ListarDetalleVenta90901() as $re):
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h3 class="modal-title font-weight-bold">Farmacia San Juan</h3>
            </div>
          ...
          <label data-error="wrong" data-success="right" for="fname">Quitar Producto de La Lista</label>
            ...
            <div class="modal-footer d-flex justify-content-center">
              <button id="BotonQuitar" class="BotonQuitar" class="btn btn-info">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                <div class="md-form mb-4">
                    <i class="fa fa-user prefix grey-text"></i>
					<label data-error="wrong" data-success="right" for="fname">Apertura de Caja Farmacia San Juan</label>
                        <?
...
<div class="modal fade" id="modalContactForm6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h3 class="modal-title font-weight-bold">Cerrar Caja San Juan</h3>
            </div>
            <div class="modal-body mx-3">
                <div class="md-form mb-4">
...
<script type="text/javascript">
  ...
  function EnviarCodigo1(ProductoVenta) {
        if (ProductoVenta) {
            //MANDAR EL ID ELEGIDO MEDIANTE $.AJAX PARA PROCESAR LOS DATOS Y DEVOLVERLOS MEDIANTE JSON
            $.ajax({
                url: 'index.php?view=SistemaCaja11',
                type: 'post',
                data: {ProductoVenta: ProductoVenta},
                dataType: 'json',
                success:function(response) {       
   ...
   function onClickBotonCobrar(){
      ...
      var TotalPagar = $('#TotalPagar').val();
         ...
         $BotonCobrar.prop('disabled', true);
				 $.ajax({
					url: 'index.php?view=SistemaCaja2',
					type: 'post',
					...
					success: function(data) 
					{
						if(data.success==true)
						{
							...
							setTimeout(function()
							{
							  	...
							  	window.location.reload ('index.php?view=SistemaCajaSJ');
							}, 1000);
						}
						else
						{
  ...
  function onClickBotonQuitar(){
      ...
      else if(CodigoSleiter == '123Contra/')
      {
         $BotonQuitar.prop('disabled', true);
         $.ajax({
          url: 'index.php?view=SistemaCaja3',
          type: 'post',
    ...
    function onClickBotonAbrir(){
      ...
      else
      {
         ...
         $.ajax({
          url: 'index.php?view=SistemaCaja41',
          type: 'post',
