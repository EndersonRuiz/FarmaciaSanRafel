<?
 ...
 $boldArray = array('font' => array('bold' => true,),'alignment' => array('horizontal' => 
  ...
  $objPHPExcel->getActiveSheet()->getStyle('A1:O1')->applyFromArray($boldArray);
	...
	$objPHPExcel->getActiveSheet()->setCellValue('B1','FechaVencimiento');
	...
	$objPHPExcel->getActiveSheet()->setCellValue('F1','Precio Costo');
	$objPHPExcel->getActiveSheet()->setCellValue('G1','Precio Tope');
	...
	header('Content-Disposition: attachment;filename="InventarioBodeguita.xls"');
