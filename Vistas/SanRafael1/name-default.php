					...
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
						<div class="full-width panel mdl-shadow--2dp">
							<div class="full-width panel-tittle text-center tittles" style="background-color: #4B0082">
								Salidas de Productos Farmacia San Rafael 1
							</div>
							...
							<div class="full-width panel-content">
								<div class="row">
                                   ...
                                   <button  class="btn btn-primary" style="background-color: #006400 " onclick="insertarDatos2()" data-target="#modalContactForm1" data-toggle="modal">
                                        <i class="glyphicon glyphicon-shopping-cart" ></i> ++++
                                   </button>

                                   <button  class="btn btn-primary" style="background-color: #006400 " onclick="insertarDatos1()" data-target="#modalContactForm2" data-toggle="modal">
                                        <i class="glyphicon glyphicon-shopping-cart" ></i> - - - -
                                   </button>
                                   <br></br>
                                </div>
									...
									<table class="table table-bordered table-hover" class="table table-striped" >
										...
										<tbody>
											<tr>
												...
												<td> 
													<button type="submit" class="btn btn-primary" id="AgregarAFactura" style="background-color: #006400 ">
							...
							<div class="container">
						 		<div class="row">
									...
									<div class="panel panel-info">
										...
										<div class="panel-body detalle-producto">
											<?php
											session_start();
											 if(count($_SESSION['DetalleSanRafael'])>0){?>
												<table class="table">
												    <thead>
												        <tr>
												        	<th>Id</th>
												    ...
												    <tbody>
												        ...
												        <tr>
												            ...
												            <td><button type="button" class="btn btn-sm eliminar-producto" style="background-color: #006400 " id="<?php echo $detalle['id'];?>">Eliminar</button></td>
												        </tr>
												        <?php }?>
												    </tbody>
												</table>
								...
								<div class="row">
									<div class="col-md-2 text-right">
										<button  class="btn btn-primary" style="background-color: #006400 " onclick="DatosVacios()" data-target="#modalContactForm3" data-toggle="modal">
	...
	<script>
       ...
       function DataProduct456(ProductoVenta) 
        ...
        $('#AgregarAFactura').unbind('click').bind('click', function(){
	        ...
	        {
	        	$.ajax({
					url: 'index.php?view=VerificaExistencia',
					type: 'post',
					data: {
					...
					success: function(data) 
					{
						if(data.success==true)
						{
							...
							$(".detalle-producto").load('index.php?view=DetalleVenta');
						}
						else
						{
		...
		$(".eliminar-producto").on("click", function(e) 
		{
			var id = $(this).attr("id");
			$.ajax({
				url: 'index.php?view=EliminarDetalleVentaSanRafael',
				type: 'post',
				data: {'id':id},
				dataType: 'json'
			}).done(function(data)
		...
		$(".guardar-carrito").on("click", function(e) 
		{
			...
			{  
				 ...
				 $.ajax({
					url: 'index.php?view=AddDetalleVentaSanRafael_1',
					type: 'post',
					...
					success: function(data) 
					{
						if(data.success==true)
						{
							...
							setTimeout(function()
							{
							  	...
							  	window.location.reload ('index.php?view=SanRafael1');
							}, 1000);
						}
						else
						{
