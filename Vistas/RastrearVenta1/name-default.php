				...
				<div class="mdl-grid">
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
						<div class="full-width panel mdl-shadow--2dp">
							<div class="full-width panel-tittle text-center tittles" style="background-color: #A40312">
								Ventas del Producto en Farmacia
							</div>
							...
							<div class="full-width panel-content">
								...
								<div class="row">
									<?
								        ...
								        foreach($model->RastrearProductoVenta1($_REQUEST['Origen'],$_REQUEST['Producto'],$_REQUEST['Fecha'],$_REQUEST['Fecha1']) as $r): 
								    ?>
									<br></br>
                                    <div class="col-md-3">
                                    	Nombre Producto
								...
								<div class="row table-responsive">
									<table class="table table-bordered table-hover" class="table table-striped" id="TableUsers">
										<thead class="bg-primary">
											<tr style="background-color: #A40312;">
												<th width="100px">
													<center>
														IdVenta
													</center>
									...
									<?
								        ...
								        $model = new Ventas ();
								        //CARGAR LOS CAMPOS A LA VARIABLE $r
								        foreach($model->RastrearProductoVenta($_REQUEST['Origen'],$_REQUEST['Producto'],$_REQUEST['Fecha'],$_REQUEST['Fecha1']) as $r): 
								    ?>
						            <tr>
