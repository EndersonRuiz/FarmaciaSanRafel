<?
	...
	if ($_REQUEST['Codigo'] == 1201)
	{
		print '<script>window.location = "index.php?view=ReporteDR";</script>';
	}
    if ($_REQUEST['Codigo'] == 1202)
	{
		print '<script>window.location = "index.php?view=ReporteDrPorcentaje";</script>';
	}
