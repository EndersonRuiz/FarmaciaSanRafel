...
?>
 ...
 <!-- pageContent -->
							...
							<div class="full-width panel-content">
									<div class="mdl-grid">
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											...
											<div class="col-5">
                                            <h4>Nuevos Reportes de Ventas</h4>
                                                <a href="#" data-toggle="modal" data-target="#modlaContactForm7845" class="btn btn-danger">Productos Sin Vender</a>
                                                <a href="#" data-toggle="modal" data-target="#modalContacform124" class="btn btn-danger" >Productos Mas Vendidos</a> 
                                            </div>  
										...
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											...
											<h4>Nuevo Reporte Listado DR.</h4>
											<div class="col-5">
												<button id="send" class="btn btn-info">
            	                                <a href="index.php?view=Option&Codigo=1201" class="btn btn-default" style="background-color: #E6E6E6; width: 160px;">Listado DR.</a>
            	                                </button>
											</div>
											<h4>Nuevo Reporte Listado DR. Estimacions Porcentaje</h4>
                                            <div class="col-5">
                                                <button id="send" class="btn btn-info">
                                                <a href="index.php?view=Option&Codigo=1202" class="btn btn-default" style="background-color: #E6E6E6; width: 160px;">Listado DR.</a>
                                                </button>
                                            </div>
										</div>
									</div>
	...
	<div class="modal fade" id="modlaContactForm7845" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard= "false">
          ...
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h4 class="modal-title">
                      <i class="fa fa-eye"></i>
                      Reporte Productos (No Vendidos Por Rango)
                  </h4>
              </div>
              <form action="index.php?view=ReporteProductos1" method="post" enctype="multipart/form-data" autocomplete="off">
                  <div class="modal-body" style="max-height: 300px; overflow: auto;" id="bodyDetalle">
                              ...
                              <div role="tabpanel" class="tab-pane active" id="photo">
                                  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                      <div class="col-md-4">
                                          <div>
                                              <h5>Sucursal</h5>
                                              <select name="SucursalSan" id="SucursalSan" class="form-select" aria-label="Default select example" required="">
                                                  <option value="1">Farmacia San Juan</option>
                                                  <option value="5">Farmacia San Rafael 1</option>
                                                  <option value="4">Farmacia San Rafael</option>
                                              </select>
                                          </div>
                                      </div>
                                      <div class="col-md-4">
  ...
  <div class="modal fade" id="modalContacform124" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  ...
                  <h4 class="modal-title">
                      <i class="fa fa-eye"></i>
                      Reportes Productos Mas Vendidos (por Rango).
                  </h4>
              </div>
              <form action="index.php?view=ReporteProductos2" method="post" enctype="multipart/form-data" autocomplete="off">
                  <div class="modal-body" style="max-height: 300px; overflow: auto;" id="bodyDetalle">
                      <div class="div-result">
                          <div class="tab-content">
                              <div role="tabpanel" class="tab-pane active" id="photo">
                                  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                      <div class="col-md-4">
                                          <div>
                                              <h5>Sucursal</h5>
                                              <select name="SucursalSanr" id="SucursalSanr" class="form-select" aria-label="Default select example" required="">
                                                  <option value="1">Farmacia San Juan</option>
                                                  <option value="5">Farmacia San Rafael 1</option>
                                                  <option value="4">Farmacia San Rafael</option>
                                              </select>
                                      ...
                                      <div class="col-md-4">
                                          <div>
                                              <h5>Fecha Inicio</h5>
                                              <input type="date" name="FechaInicio1" id="FechaInicio1" class="form-control" required="">
                                          </div>
                                      </div>
                                      <div class="col-md-4">
                                          <div>
                                              <h5>Fecha Fin</h5>
                                              <input type="date" name="FechaFin1" id="FechaFin1" class="form-control" required="">
                                          </div>
                                      </div>
                                  </div>
                              </div>
	 ...
	 <div class="modal fade" id="modalContactForm4211" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
             ...
             <form action="prueva/reporte/" method="post" enctype="multipart/form-data" autocomplete="off">
