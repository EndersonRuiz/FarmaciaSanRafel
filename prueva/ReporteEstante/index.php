<?php
	...
	$pdf->Cell(15,6,'Dato',1,1,'C',1);
	
	$pdf->SetFont('Arial','',10);
	
	foreach ($model->ListarReporteEstante($_REQUEST['ReporteEstante1'],$_REQUEST['ReporteEstante']) as $r) 
	{
		...
		$pdf->Cell(15,4,utf8_decode($r->Seccion),1,0,'C');
		$pdf->Cell(15,4,utf8_decode(""),1,1,'C');
	}
