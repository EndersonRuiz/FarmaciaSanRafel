<?
    class VentasSanJuan
    {
            ...
            {  
                try
                {
                    ...
                    $this->SentenciaSql = "select concat(c.PrimerNombre,' ',c.PrimerApellido,' ',c.SegundoApellido) as NombreCompleto,sum(a.Total) as Total,sum(a.Bono) as Bono, 
                        ...
                        from ventasanjuan a,abrircaja b, usuario c where a.Fecha = '".$Inicio."' and a.IdCaja = b.Codigo and a.IdUsuario = c.Codigo and b.Turnos = '".$Turnos."' and a.Estado = 0 and a.IdSucursal = '".$Sucursal."' group by a.IdUsuario";  
                  $this->Result = array();
        ...
        {  
            ...
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "select a.NombreProducto, b.Cantidad,b.PrecioCosto,b.SubTotal, d.codigo, d.Fecha,d.Hora, concat(e.PrimerNombre,' ',e.PrimerApellido,' ',e.SegundoApellido) as NombreCompleto, d.Total1 from producto a, detalleventasanjuan b,inventario c, ventasanjuan d,usuario e where b.idinventario = c.Codigo and a.Codigo = c.IdProducto and d.Codigo = b.Idventa and d.Estado = 1 and d.IdSucursal = '1' and d.IdUsuario = e.Codigo;";
                $this->Result = array();
                $this->Procedure = $this->ConexionSql->prepare($this->SentenciaSql);
                $this->Procedure->execute();
                return $this->Procedure->fetchAll(PDO::FETCH_OBJ);
            ...
            {  
                try
                {
                    ...
                    $this->SentenciaSql = "select a.Codigo,a.Fecha,a.Hora,concat(c.PrimerNombre,' ',c.PrimerApellido,' ',c.SegundoApellido) as NombreCompleto,
                     ...
                     from ventasanjuan a,abrircaja b, usuario c
            ...
            {  
                try
                {
                    ...
                    $this->SentenciaSql = "select sum(a.Total) as Total,sum(a.Bono) as Bono, sum(a.descuento) as Descuento, sum(Total1) as TotalCobrado
                        from ventasanjuan a,abrircaja b 
        ...
        public function ListarDetalleVenta1($Cod)
        {  
            try
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "select a.NombreProducto, b.Cantidad,b.PrecioCosto,b.SubTotal 
                from producto a, detalleventasanjuan b,inventario c
          ...
          public function ExtraerDatosCaja()
        {
            ...
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "select max(Codigo) as Codigo,max(Estado) as Estado from abrircaja where IdSucursal = '1'";
                $this->Result = array();
                $this->Procedure = $this->ConexionSql->prepare($this->SentenciaSql);
                $this->Procedure->execute();
                return $this->Procedure->fetchAll(PDO::FETCH_OBJ);
        ...
        public function AbrirCaja1()
        {
            ...
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "call RegistroAbrirCaja(?,1,?,?)";
                $this->Procedure = $this->ConexionSql->prepare($this->SentenciaSql);
         ...
         public function EliminarDatosVenta()
        {
            ...
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "call QuitaVentaSanJuan(?)";
                $this->Procedure = $this->ConexionSql->prepare($this->SentenciaSql);
        ...
        public function InsertarVentass()
        {
            ...
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "call CobrarSanJuan(?,?,?)";
                $this->Procedure = $this->ConexionSql->prepare($this->SentenciaSql);
        ...
        public function ObtenerDatosVenta($Cod)
        {
            ...
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "SELECT a.Codigo,a.Total1,b.Codigo as CodigoCaja from ventasanjuan a,abrircaja b 
                 where a.Codigo = '".$Cod."' and b.IdSucursal = '1' and b.Estado = '1'";
                $this->Result = array();
                $this->Procedure = $this->ConexionSql->prepare($this->SentenciaSql);
                $this->Procedure->execute();
                return $this->Procedure->fetchAll(PDO::FETCH_OBJ);
       ...
       public function ObtenerCodigo($cod)
        {
            ...
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "SELECT MAX(a.Codigo) AS Codigo,b.Codigo as cod,b.CodigoReservado as Cod2 FROM ventasanjuan a,usuario b where b.CodigoReservado = '".$cod."'";
                $this->Procedure = $this->ConexionSql->prepare($this->SentenciaSql);
                $this->Procedure->execute();
                $row = $this->Procedure->fetch();
                $this->setCodigo($row['Codigo']);
        ...
        public function InsertarVenta()
        {
            ...
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "call InsertarSanJuan(?,?,?,?,?,?,?)";
                $this->Procedure = $this->ConexionSql->prepare($this->SentenciaSql);
         ...
         public function Insertar()
        {
            ...
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "call RegistroDetalleSanJuan(?,?,?,?,?)";
                $this->Procedure = $this->ConexionSql->prepare($this->SentenciaSql);
        ...
        {  
            try
            {
                ...
                $this->SentenciaSql = "select a.Codigo,a.Fecha,a.Hora,concat(b.PrimerNombre,' ',b.PrimerApellido,' ',b.SegundoApellido) as NombreCompleto,
                      a.Total,a.Bono,a.descuento,a.Total1 
                      from ventasanjuan a, usuario b
                      where b.Codigo = a.IdUsuario and a.Estado = 0
        ...
        {  
            ...
            {
                $this->ConexionSql = $this->Conexion->CrearConexion ();
                $this->SentenciaSql = "call ConsultaParaCerrarCaja1()";
                $this->Result = array();
                $this->Procedure = $this->ConexionSql->prepare($this->SentenciaSql);
                $this->Procedure->execute();
                return $this->Procedure->fetchAll(PDO::FETCH_OBJ);
